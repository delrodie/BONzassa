...
class Communaute
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\ImgCommunaute", cascade={"persist", "remove"})
     */
     private $image;
     ...
     * Set image
     *
     * @param \AppBundle\Entity\ImgCommunaute $image
     *
     * @return Communaute
     */
    public function setImage(\AppBundle\Entity\ImgCommunaute $image = null)
    {
        $this->image = $image;
     ...
     * Get image
     *
     * @return \AppBundle\Entity\ImgCommunaute
     */
